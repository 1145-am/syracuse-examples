...
Usage: uv run python examples/stories.py
"""
...
def list_recent_stories_httpx():
    """Fetch technology stories from the last 7 days using httpx."""
    import httpx

    print("=== Recent Technology stories (last 7 days) — httpx ===\n")
    response = httpx.get(
...
def list_recent_stories_requests():
    """Fetch technology stories from the last 7 days using requests."""
    import requests

    print("=== Recent Technology stories (last 7 days) — requests ===\n")
...
if __name__ == "__main__":
    list_recent_stories_httpx()
    list_recent_stories_requests()
